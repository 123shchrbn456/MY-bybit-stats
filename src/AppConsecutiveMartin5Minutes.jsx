...
import { getOneMonthData5MinutesInterval } from "./utilsConsecutiveMartin5Minutes/api5MinutesConsecutiveMartin";
import { tryToSee5MinutesHorizontal } from "./utilsConsecutiveMartin5Minutes/stats5MinutesConsecutiveMartin";
...
function AppConsecutiveMartin5Minutes() {
    ...
    useEffect(() => {
        ...
        async function getDataWithDelays() {
            ...
            try {
                ...
                const allMonthsResult = promiseResults.reduce((accumulator, currentValue) => [...accumulator, ...currentValue], []);
                allMonthsResult.sort((a, b) => new Date(a.finishedTime) - new Date(b.finishedTime)); /* sort by days */
                const oneMonthDataWithOutcomes = tryToSee5MinutesHorizontal(coinName, allMonthsResult);
...
export default AppConsecutiveMartin5Minutes;
