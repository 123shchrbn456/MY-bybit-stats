...
function App() {
    ...
    function createRequestLink(coin, month) {
        const url = `https://api.bybit.com/derivatives/v3/public/kline?category=linear&symbol=${COIN}USDT&interval=60&start=${dateStartJul}&end=${dateEndJul}`;
        return;
    }
